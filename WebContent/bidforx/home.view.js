sap.ui.jsview("bidforx.home", {
	...
	*/ 
	createContent : function(oController) {
		...
		this.oData={
				"login_user_details":[
					{"user1":"admin","pass1":"admin","mail1":"admin@pivoxlabs.com"},
					{"user1":"yaswanth","pass1":"yaswanth","mail1":"yaswanth@pivoxlabs.com"}
				],
				"signupFormData":{
    	    			...
    	    			new sap.ui.layout.form.FormElement({
    	    				...
    	    				fields:[
    							...
    							({
    							    ...
    							    width: "80%",
    							    value:"{user_account>/signupFormData/user1}"
//    							    change:(oEvt)=>{
//    							    	oEvt.getSource().setValue(oEvt.getParameters().value);
//    							    }
    							}),
    							new sap.m.Input
    							({
    								placeholder:"password",type:sap.m.InputType.Password,width: "80%",
    								value:"{user_account>/signupFormData/pass1}"
    							}),
    							new sap.m.Input
    							({
    								placeholder:"email",type:sap.m.InputType.Email,width: "80%",
    								value:"{user_account>/signupFormData/mail1}"
    							}),
