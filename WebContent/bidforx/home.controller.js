...
//							mAggregations.formElements[0].mAggregations.fields[1].setValue('');
							...
							this.getView().formtag_login.setVisible(false);
							alert("Mr. "+login_user+" your login is successful");
							//setting true for successful sign up
							wrong ="true";
...
signup(){				
				debugger
				var up_user=this.oView.getModel("user_account").getProperty("/signupFormData");
				...
				if(up_user){
					...
					if(oModel){						
						...
						if(aLoginUserDetails){
							debugger
							aLoginUserDetails.push(JSON.parse(JSON.stringify(up_user)));
					...
					alert("Mr. "+up_user+" YOUR SIGNUP IS SUCCESSFUL");
					this.oView.formtag_signup.mAggregations.formContainers[0].
					mAggregations.formElements[0].mAggregations.fields[0].setValue('');
					this.oView.formtag_signup.mAggregations.formContainers[0].
					mAggregations.formElements[0].mAggregations.fields[1].setValue('');
